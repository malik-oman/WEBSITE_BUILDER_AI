...
import exractJson from "../utils/extractJson.js";
...
export const generateWebsite = async (req,res) => {
    ...
    if (!prompt) {
      ...
      if(!parsed.code){
        ...
        return res.status(400).json({message:"Ai Return InvalidResponse"})
      }
